...
//  Method for selecting things suitable by weight
    private ArrayList<Thing> getSuitableListOfThing(List<Thing> things, int capacity) {
...
//  Method create sets of things passing through the matrix
    private void createSetsOfThings(ArrayList<Thing> things) {
    ...
    private int getCostOfSet(ArrayList<Thing> things) {
        int cost = 0;
        for (Thing thing : things) {
            cost+= thing.getCost();
        }
    ...
    private int getWeightOfSet(ArrayList<Thing> things) {
        int weight = 0;
        for (Thing thing : things) {
